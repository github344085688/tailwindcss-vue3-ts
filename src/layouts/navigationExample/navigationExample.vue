<template>
  <div :class="[isFold ? 'fold':'expand']"
    ...
    <div class="flex flex-col  w-[3.375rem] min-w-[3.375rem] sm:w-[15rem] sm:min-w-[15rem] parent-level h-full bg-primary-300 dark:bg-primary-900 transition-all duration-500     relative group-[.fold]:w-[3.375rem] group-[.fold]:min-w-[3.375rem] shadow-xl ring-1 ring-primary
     dark:highlight-white/5  dark:ring-0
">
 ...
 ring-1 ring-gray-900/5 dark:highlight-white/1 dark:ring-0"
      ...
      <div class="dark:bg-primary-800 flex-1 pt-[4px] dark:highlight-white/5  dark:ring-0">
...
"
            ...
            ">
                <li v-for="(secondItem,secondIndex) in firstItem.children" :key="secondIndex"
                    :class="[secondNavName == secondItem.title?'secondItemActive active ':'' ,
...
">
                  <div
                   ...
                   "
                    ...
                    <div class="  rounded-sm h-full px-[12px] flex items-center  cursor-pointer  transition-colors duration-500   border-t-[1px] border-transparent
                    text-accent-900
                    bg-primary-300
                    hover:text-secondary-550
                    hover:bg-primary
