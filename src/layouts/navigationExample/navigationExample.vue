...
">
      <div class=" absolute -right-[0.8rem] top-[1.3rem] cursor-pointer box-shadow-xs dark:bg-primary-900 bg-primary-300 dark:shadow-primary-800 w-[28px] h-[28px] flex rounded items-center justify-center
      ...
      <div v-for="(child, startIndex) in navLink" :key="startIndex">
        ...
        ">
          <li :class="[navName==firstItem.title ? 'group active firstItemActive':'unActive'] "
            ...
            ">
              <!--              group-hover/firstItemLi:left-[45px]-->
...
">
                <div
                  ...
                  <div
                      class="group-[.fold]:hidden line  sm:block  group:sm:block  sm:bottom-0  sm:m-auto  sm:left-[25px]  sm:top-0  sm:absolute  sm:w-[10px]  sm:h-[1px]  sm:bg-primary-400  "></div>
                ...
                <ul v-if="secondItem.children && secondItem.children.length>0" class="
                  ...
                  peer-[.secondItemActive]:before:content-baseline
                  peer-[.secondItemActive]:before:content-open-quote
                  peer-[.secondItemActive]:before:absolute
                  peer-[.secondItemActive]:before:bg-primary-400
                  peer-[.secondItemActive]:before:left-[25px]
                  peer-[.secondItemActive]:before:w-[1px]
                  peer-[.secondItemActive]:before:top-0
                  peer-[.secondItemActive]:before:bottom-0 ">
...
<template>
  <div :class="[isFold ? 'fold':'expand']" class="group aside-unfold transition-all duration-500 relative h-full flex">
    <div class="
          ...
          relative
          pt-[25px]
          group-[.fold]:w-[4.375rem]
          group-[.fold]:min-w-[4.375rem]
">
      <div
          class="
            absolute
...
"
      ...
      <div v-for="(child, startIndex) in navLink" :key="startIndex">
        <group-name :groupName="child.groupName" class="group-[.fold]:hidden"></group-name>
        <ul v-for="(firstItem, firstIndex) in child.children" :key="firstIndex" class="sn_menu
                          sm:max-h-[300px]
                          group-[.expand]:sm:overflow-hidden
                          group-[.expand]:sm:overflow-y-auto
                          group-[.expand]:sm:overflow-x-hidden
                          scrollbar

">
          <li :class="{ 'group active firstItemActive':navName==firstItem.title}"
              class="group-[.fold]:relative overflow-hidden group-[.fold]:sm:overflow-inherit">
            <div class="mx-1
                        px-2
                        flex
                        h-full
                        ...
                        duration-500
                        cursor-pointer
                        group-[.active]:bg-secondary-300
                        group-[.active]:dark:bg-secondary-600
                        group-[.active]:text-secondary-800
                        group-[.active]:dark:text-secondary-400
                        group-[.active]:border-primary-300
                        group-[.active]:dark:border-t-primary-800
                        dark:shadow-primary-800
                        dark:text-primary-300
                        text-primary-800
                        border-t-[1px]
              ...
              <div v-if="firstItem.children && firstItem.children.length>0" class="ml-auto group-[.fold]:hidden">
                <svg class="fill-secondary-700
                         group-[.linkActive]:fill-secondary-400 "
                     fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.50024 17L14.5002 12L9.50024 7V17Z"/>
            ...
            <ul v-if="firstItem.children && firstItem.children.length>0"
                class="group-[.fold]:absolute group-[.fold]:t-0 group-[.fold]:l-[4.375rem]">
              <li v-for="(secondItem,secondIndex) in firstItem.children" :key="secondIndex"
                  :class="[itemChildsLink == secondItem.title?'secondItemActive active ':'' ,
                  (secondIndex != firstItem.children.length-1)? 'relative  before:content-baseline before:content-open-quote  before:absolute before:bg-primary-400  before:left-[25px] before:w-[1px]  before:top-0  before:bottom-0':'beforeUnderline'
                  ]"

                  class="secondItem
                  overflow-hidden
                  group group-[.fold]:absolute
                  group-[.fold]:w-[15rem]
                  group-[.fold]:h-[15rem]
                  group-[.fold]:overflow-inherit
                  group-[.fold]:active
...
">
                <div
                  ...
                  pr-[4px]
                  relative
                  group-[.beforeUnderline]:before:content-baseline
                  group-[.beforeUnderline]:before:content-open-quote
                  group-[.beforeUnderline]:before:absolute
                  group-[.beforeUnderline]:before:bg-primary-400
                  group-[.beforeUnderline]:before:left-[25px]
                  group-[.beforeUnderline]:before:w-[1px]
                  group-[.beforeUnderline]:before:top-0
                  group-[.beforeUnderline]:before:bottom-0
                  " tabindex="-1"
                    @click.stop.prevent="foldChildetails($event,secondItem,firstItem)">
                  <div class="line
                  ...
                  <div class="  rounded
                                ...
                                dark:border-transparent
                                border-solid
                                group-[.secondItemActive]:bg-secondary-300
                                group-[.secondItemActive]:dark:bg-secondary-600
                                group-[.secondItemActive]:text-secondary-800
                                group-[.secondItemActive]:dark:text-primary
                                group-[.secondItemActive]:border-primary-300
                                group-[.secondItemActive]:dark:border-t-primary-800
                ...
                <ul v-if="secondItem.children && secondItem.children.length>0" class="
                  ...
                  <li v-for="thirdItem in secondItem.children"
                      :class="{'group fourthItemActive active':fourthItemActiveName   == thirdItem.title }"
                      class="thirdItem overflow-hidden group-[.fold]:overflow-inherit">
                    &lt;!&ndash;                <second-items><a href="#">{{ secondItem.title }}</a></second-items>&ndash;&gt;
                    <div class="
                  beforeLines
                  h-full
                  pl-[60px]
